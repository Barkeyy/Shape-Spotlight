	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement([/*'week1_nomiss', 'week2_nomiss', 'week3_nomiss', 'week4_nomiss',
				'week5_nomiss', 'week6_nomiss', 'week7_nomiss',*/'weekrick_nomiss', 'ur_bad',
	...
	private function checkForAchievement(achievesToCheck:Array<String> = null):String
	{
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				{
					//case /*'week1_nomiss' | 'week2_nomiss' | 'week3_nomiss' | 'week4_nomiss' | 'week5_nomiss' | 'week6_nomiss' | 'week7_nomiss'|'weekrick_nomiss':
					case 'weekrick_nomiss':
						if(isStoryMode && campaignMisses + songMisses < 1  && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							if (CoolUtil.difficultyString() == 'NORMAL'){
							...
							/*	case 'week1':
								...
								case 'week7':
									...
									*/
								case 'weekrick':
								if(achievementName == 'weekrick_nomiss') unlock = true;
							}
						}
							if (CoolUtil.difficultyString() == 'NORMAL'){
								var weekName:String = WeekData.getWeekFileName();
