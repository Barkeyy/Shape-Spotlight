...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		if (titleJSON.backgroundSprite != null && titleJSON.backgroundSprite.length > 0 && titleJSON.backgroundSprite != "none"){
			...
			bg.makeGraphic(FlxG.width, FlxG.height, 0xFF705cad);
		}
		bg.color = 0xFF705cad;
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					...
					#else
					createCoolText(['Barkey', 'Barkey', 'Barkey', 'and Barkey']);
					#end
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Spotlight'); // credTextShit.text += '\nFunkin';
