...
class Achievements {
	...
	/*	["Freaky on a Friday Night",	"Play on a Friday... Night.",						'friday_night_play',	 true],
		...
		*/
		["Contest destroyer",			"Beat Week Rick on Normal with no Misses.",				'weekrick_nomiss',			false],
		["Contest incinerator",			"Beat Week Rick on Hell with no Misses.",				'weekrickhell_nomiss',			false],
